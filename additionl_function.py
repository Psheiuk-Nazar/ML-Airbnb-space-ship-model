...
def rle_encode(img, min_max_threshold=1e-3, max_mean_threshold=None) -> str:
    """
...
def rle_decode(mask_rle: str, shape=(768, 768)) -> ndarray:
    """
...
def masks_as_image(in_mask_list: list) -> np.zeros:
...
def masks_as_color(in_mask_list: list) -> np.zeros:
